  ...
  return (
    <div className="container ">
      ...
      <main className="my-10">
        ...
        <h2 className="my-5">
          I&#39;m a Front End developer based in South Korea. I&#39;m passion
          for creating visually stunning and user-friendly websites.
        </h2>
        <h2>
          I&#39;m currently working at Optatum Platform as a Front End developer
          to grow its payment solution.
        </h2>
      </main>
      <div className="my-10">
